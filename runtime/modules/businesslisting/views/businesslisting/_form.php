            ...
            <div id="registration-tabs"> <a href="javascript:void(0);">My account</a>
             ...
             <a class="pu-close pu-close-step2 pu-close1" href="javascript:void(0);" title="Close">X</a>
				...
				<div class="sl-basic-info">
					...
					<br>
					<label>Title <a href="#;" class="sl-tip tooltip">?<span class="classic">Enter your business title.</span></a></label>
					<br>
					...
					else
					{
					   if($model->user_default_business_title){
					       ...
					       $slogan = $modelData->user_default_business_title;
					   }
					...
					<br>
					 ...
					 {
                        echo $form->textArea('Businesslisting[user_default_business_whoweare]',$modelNew->user_default_business_whoweare,array('size'=>60,'id'=>'whoweare','class'=>'inp textarea-full','style'=>'height:196px','tabindex'=>5));
					 }else
					 {
						echo $form->textArea($model,'user_default_business_whoweare',array('size'=>60,'id'=>'whoweare','class'=>'inp textarea-full','style'=>'height:196px','tabindex'=>5));
					 }
				 ...
				 <div class="sl-basic-info">
                     ...
                     <?php
						...
						{
							echo $form->textArea('Businesslisting[user_default_business_offer]', $modelNew->user_default_business_offer,array('size'=>60,'id'=>'offer','class'=>'textarea-full','style'=>'height:70px','tabindex'=>6));
						}
						else
						{
                        	echo $form->textArea($model,'user_default_business_offer',array('size'=>60,'id'=>'offer','class'=>'textarea-full','style'=>'height:70px','tabindex'=>6));                    }
				 ...
				 <div class="sl-basic-info">
				  ...
				  <label>Enter keywords for our search engine.<a class="sl-tip tooltip" href="#;">?<span class="classic">
                     ...
                     <?php echo $form->textArea($model,'user_default_business_keyword',array('class'=>'textarea-full','id'=>'user_default_business_list_keyword','style'=>'height:100px','tabindex'=>8)); ?>
