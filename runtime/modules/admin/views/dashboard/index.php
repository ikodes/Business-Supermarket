 <div class="content">
    <div class="right_content">
      ...
      <ul class="main_icons">
        ...
        <li>
            <?php  $pendingforlisting = Userlisting::Model()->count("user_default_listing_submission_status=:field", array("field" =>0)); ?>
      ...
      <ul class="main_icons">
        <li>
            <a href="<?php echo $this->createUrl('/admin/slider/slider');?>" title="Business supermarket update Sliders">
              <img  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/update_slider.png" width="75px" height="75px" />
            </a>
        </li>
        <li>
            <a href="<?php echo $this->createUrl('/admin/pages/pages');?>" title="Business supermarket update pages">
              <img  src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/slider_create.png" width="75px" height="75px" />
            </a>
        </li>
        <li>
