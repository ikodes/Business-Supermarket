...
$command = $connection->createCommand("update `user_default_prize_draw` set prize_value='$prize_value',points_required='$points_required' where `id`='$prizeid'");
...
$PrizeDrawWinners = new PrizeDrawWinners;
                     $PrizeDrawWinners->user_default_id = $_POST['win_username'];
