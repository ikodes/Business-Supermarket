...
<?php
  $listingpages = CHtml::listData(User::model()->findAll(array('order'=>"`user_default_username` ASC")), 'user_default_id', 'user_default_username');
                        echo $form->dropDownList($model, 'user_default_id', $listingpages, array('class' => 'chzn-select', 'data-placeholder' => 'Please select', 'onfocus' => 'getSelectNormal("#user_default_id");', 'id' => 'user_default_id'));
