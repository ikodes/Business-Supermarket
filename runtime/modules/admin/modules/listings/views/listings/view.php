...
$this->menu=array(
	...
	array('label'=>'Update Listing', 'url'=>array('update', 'id'=>$model->drg_lid)),
	array('label'=>'Delete Listing', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->drg_lid),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Listing', 'url'=>array('admin')),
);
?>

<h1>View Listings #<?php echo $model->drg_lid; ?></h1>
