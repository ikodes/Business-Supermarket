...
$uid=$model['user_default_profiles_id'];$userModel = User::model()->findByAttributes(array("user_default_id"=>$uid)); $useraddress = Useraddress::model()->findByAttributes(array("user_default_profile_id"=>$uid));                                                  $Country = Country::model()->findByAttributes(array('user_default_country_id'=>$userModel->user_default_country));?>
                    ...
                    <td>
                        <table width="100%" align="center">
                            <tr><td width="100" class="tbl1">Address :</td><td class="last" id="tbl2"><?php echo $useraddress->user_default_address; ?></td></tr>							<tr><td width="100" class="tbl1">County:</td><td class="last" id="tbl2"><?php echo $useraddress->user_default_county;; ?></td></tr>
        ...
        for ($j = 1; $j <= 2; $j++) {
            ...
            ?> width:360px;">
                ...
                <div id="preview-<?php echo $j; ?>" class="sl-photograph video_preview" style="margin-left: 90px;">                                   
                      <?php
$path1 = $_SERVER['DOCUMENT_ROOT'].'/';                                          $uservideoname = "";										                                        $videolink = "";										                                         $insert = true;										                                         if($uservideo[$k]->user_default_listing_video_link!="")											                                        { 										$insert = false;										                                            $uservideoname = $uservideo[$k]->user_default_listing_video_link;											                                            $videolink = $uservideo[$k]->user_default_listing_video_type;											                                        }										$apath= $path1."upload/users/".$userfolder."/videos/".$uservideoname;
                    ?>
                ...
                <div id="ova-example-player-container_<?php echo $j; ?>" class="video_player_container" style="">
                    <div id="ova-example-player_<?php echo $j; ?>" style="position:relative;">
                        <div id="ova-player-instance_<?php echo $j; ?>" loaded="false" class="video_player_instances" style=""> 
                            <!-- SELECTED PLAYER INSTANCE GOES IN HERE -->														                        <?php                        /*if (file_exists($apath)) {if($uservideoname!=""){                              ?> <script language="javascript">                                jwplayer("ova-player-instance_<?php echo $j; ?>").setup({                                flashplayer: "<?php echo Yii::app()->theme->baseUrl; ?>/js/jwplayer1/jwplayer.flash.swf",                                file: '<?php echo Yii::app()->baseUrl; ?>/upload/users/<?php echo $userfolder;?>/videos/<?php echo $uservideoname; ?>',                                height: 260,                                width: 338,                                });                            </script>                              <?php                       } }else if($videolink=="1"){?>                             <script language="javascript">                                jwplayer("ova-player-instance_<?php echo $j; ?>").setup({                                flashplayer: "<?php echo Yii::app()->theme->baseUrl; ?>/js/jwplayer1/jwplayer.flash.swf",                                file: '<?php echo $uservideoname; ?>',                                  height: 260,                                width: 338,                                });                            </script> <?php}*/                        ?>												
                        </div>
                    </div>
                </div>
                <br />
...
<?php echo $form->textArea($model, 'user_default_listing_question', array('id' => 'drg_list_maketing_question', 'class' => 'textarea-full mark-text', 'onfocus' => "getNormal('#drg_list_maketing_question');",)); ?>
        ...
        <div style="text-align:center; margin:20px 0;">
            ...
            <input name="user_default_listing_notification_frequency" <?php echo ($model->user_default_listing_notification_frequency == 'day') ? 'checked="true"' : '' ?> value="day" type="radio" style="margin: 0 0 0 0px;" /> <?php echo "Day"; ?>
            <input name="user_default_listing_notification_frequency" <?php echo ($model->user_default_listing_notification_frequency == 'week') ? 'checked="true"' : '' ?> value="week" type="radio" style="margin: 0 0 0 60px;" /> <?php echo "Week"; ?>
            <input name="user_default_listing_notification_frequency" <?php echo ($model->user_default_listing_notification_frequency == 'month') ? 'checked="true"' : '' ?> value="month" type="radio" style="margin: 0 0 0 60px;" /> <?php echo "Month"; ?>
        ...
        <!--<a href="<?php echo Yii::app()->createUrl('/admin/listings/listings/delete', array('id' => $model->user_default_listing_id)); ?>" class="button red">Delete</a>-->
            <?php if ($model->user_default_listing_submission_status == 3) { ?>
                ...
                <a href="javaScript:void(0)<?php //echo Yii::app()->createUrl('/admin/listings/listings/rdelete',array('id'=>$model->user_default_listing_id));  ?>"  class="button red">Delete</a></td>				<a href="javaScript:void(0)<?php //echo Yii::app()->createUrl('/admin/listings/listings/rdelete',array('id'=>$model->user_default_listing_id));  ?>" onClick="delete_confirm()"  class="button white">Cron</a></td>
<?php } ?>
