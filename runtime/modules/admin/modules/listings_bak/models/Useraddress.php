...

{
...

	{
		...
		return array(
            ...
            array('user_default_address', 'length', 'max'=>255),
			...
			array('user_default_address_id, user_default_address, user_default_town, user_default_county, user_default_country, user_default_zip, user_default_profile_id', 'safe', 'on'=>'search'),
...

	{
		...
		$criteria->compare('user_default_address',$this->user_default_address);
