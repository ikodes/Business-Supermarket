<ul>
    ...
    <li>
        ...
        if($currentMehod=="update" && $currentCuntroller=="mymessages"){ 
            echo CHtml::link('My messages', array('/'.Yii::app()->user->_user_Type.'/myaccount/update'),array('class'=>'my-active-link'));  
        }else {
   ...
   ?>
    ...
    <li>
        ...
        if($currentMehod=="update" && $currentCuntroller=="support"){ 
            echo CHtml::link('Support', array('/#'),array('class'=>'my-active-link'));  
        }else {
    ...
    <li>
        ...
        if($currentMehod=="update" && $currentCuntroller=="managefinancials"){ 
            echo CHtml::link('Manage financials', array('/#'),array('class'=>'my-active-link'));  
        }else {
