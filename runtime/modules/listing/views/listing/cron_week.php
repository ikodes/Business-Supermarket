...
$cronsql = $connection->createCommand("select * from `drg_user_listing` where `drg_listingstatus`='1' and drg_reporttime='week'");
...
$yii_user_request_id = '<a href="'.Yii::app()->getBaseUrl(true)."/"."listing"."/"."view?id=".$lid.'" target="_blank" >here >> </a>';
								...
								$subjectcc=" Listing ".$data['drg_title']." weekly update report ";
