            ...
            <div style="float:right; width:624px;">
                <ul id="sl-front-page" style="height:383px; margin:-18px 0 0 12px;">
                    <li>
                        ...
                        <a href="<?php echo Yii::app()->createUrl('banner/index/listid/'.$model->user_default_listing_id); ?>"> Select this if you wish to modify or update this listing.</a>
                    </li>
                   ...
                   <a href="<?php echo Yii::app()->createUrl('listing/user_listing_step4/listid/'.$model->user_default_listing_id); ?>""> Select this if you wish to modify / update the contents of this section.</a>
                    </li>
