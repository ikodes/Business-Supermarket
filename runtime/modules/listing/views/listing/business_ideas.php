...
<div id="taba" class="sign-up-tab_content" style="display: block;">
    ...
    <table class="sl-select">
        <tr>
            ...
            <td><select name="user_default_listing_category" data-placeholder="12" class="chzn-select" style="width:60px;" tabindex="2" onchange="window.location = '?rows='+$(this).val();">
                    <!-- <option value=""></option> -->
...
<div id="tab4" class="sign-up-tab_content">
    <table border="0" bordercolor="#fff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
            ...
            <td>
                <?php echo CHtml::dropDownList('user_default_listing_lookfor2','',$listData1,array('empty' => '','style'=>'width:100px;','class'=>'chzn-select','data-placeholder'=>'Looking for','id'=>'fav_sl_lookfor','tabindex'=>'11', 'onchange' => "window.location = '?looking_for='+$(this).val();"));?>
            </td> <!-- Looking for... -->
            <td>
