 ...
 */
class Managelisting extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Managelisting the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('drg_uid, drg_category, drg_profession, drg_viewlimit, drg_logo, drg_title, drg_desc, drg_explanation, drg_businessidea, drg_fprojections, drg_favailable, drg_famount, drg_financial_data, drg_want, drg_keyword, drg_video1, drg_video2, drg_mktquestion, drg_mktqstatus, drg_reporttime, drg_date, drg_datetime, drg_status,  drg_listtype, drg_company_name, drg_company_address1, drg_company_address2, drg_company_address3, drg_company_town, drg_company_county, drg_company_zip_code, drg_company_country, drg_company_tel_no, drg_company_fax_no, drg_listingstatus, drg_approvedate, reject_list', 'required'),
