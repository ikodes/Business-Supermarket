                ...
                <div class="pop-up" style="width:546px;">
                        ...
                        <div class="pop-up-content">
                            ...
                            <p style="color: #808080;"><strong>Didn't get the email?</strong> Please check your Spam/Junk email folder.<br />
                              ...
                              <a href="<?php echo Yii::app()->createUrl('/business/register/resendactive',array("code"=>$model->user_default_business_active_link));?>">Click here >></a>
...
<div class="clear"></div> 
 <?php $this->breadcrumbs = array('Business active'); ?>
  <?php $this->renderPartial('//layouts/breadcrumbs') ?>
<div class="registration-box">
    <h2 class="Blue">Your Account Activation link will be sent to <?php echo $model->user_default_business_email ; ?> </h2>
    ...
    <p>
      <a href="<?php echo Yii::app()->createUrl('register/businessactivation',array("code"=>$model->user_default_business_active_link));?>">Click to resend active link</a>
    </p>      
</div>    */ ?>