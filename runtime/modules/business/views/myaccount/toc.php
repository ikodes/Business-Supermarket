...
<p>Any complaints or concerns must first be taken up with the lister / member. If no solution can be found then you must summaries the history of the issue including all communications to <a href="support@<?php echo Yii::app()->params['domain']; ?>">Business Supermarket Customer Support.</a> A<?php echo Yii::app()->params['company_name']; ?> support member will then attempt to resolve the matter based on the information provided.</p>
<p>If you are a legal entity or an individual with legal representation you must first attempt to resolve any issues or grievances with the parties concerned. If you are unsuccessful you may then contact <a href="support@<?php echo Yii::app()->params['domain']; ?>">Business Supermarket Customer Support.</a> with proof of your claim for assistance in helping your resolve the matter.</p>  
...
<p>Business Supermarket and<?php echo Yii::app()->params['company_name']; ?> community work together to keep our site and services working properly and the community safe.
...
<p>You may not use our communication tools to send spam or otherwise send
   ...
   To report spam from other<?php echo Yii::app()->params['company_name']; ?> users, please contact <a href="#;">Business Supermarket Customer
   Support.</a></p>
