...
class Businesslisting extends CActiveRecord
{
	...
	public $co_name,$drg_whoweare,$co_slogon,$drg_image,$country,$drg_last_page_visit,$drg_page_visit,$drg_whatwecando;
	...
	public function rules()
	{
		...
		return array(
			array('drg_slogon,drg_whoweare,drg_offer,drg_category,drg_profession,drg_whatwecando', 'required'),
			...
			array('drg_blid, drg_uid, drg_category, drg_profession, drg_viewlimit, drg_slogon, drg_whoweare, drg_offer, drg_keyword, drg_testimonial, drg_datetime, drg_status, drg_lstatus, drg_video1, drg_video2, approved,drg_whatwecando,drg_last_page_visit,drg_page_visit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'drg_whatwecando' => 'What We Can Do',
