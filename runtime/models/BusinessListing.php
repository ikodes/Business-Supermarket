 ...
 * @property string $drg_whatwecando
 ...
 * @property string $drg_bapprovedate
 * @property integer $approved
 * @property integer $drg_blistingstatus
 * @property string $drg_bdeletedate
 * @property integer $drg_breject_list
 * @property integer $drg_page_visit
 * @property string $drg_last_page_visit
 */
class BusinessListing extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('drg_whatwecando, drg_uid, drg_category, drg_profession, drg_viewlimit, drg_slogon, drg_whoweare, drg_offer, drg_keyword, drg_testimonial, drg_datetime, drg_status, drg_lstatus, drg_video1, drg_video2, drg_bapprovedate, approved, drg_blistingstatus, drg_bdeletedate, drg_breject_list, drg_page_visit, drg_last_page_visit', 'required'),
			array('approved, drg_blistingstatus, drg_breject_list, drg_page_visit', 'numerical', 'integerOnly'=>true),
			...
			array('drg_blid, drg_whatwecando, drg_uid, drg_category, drg_profession, drg_viewlimit, drg_slogon, drg_whoweare, drg_offer, drg_keyword, drg_testimonial, drg_datetime, drg_status, drg_lstatus, drg_video1, drg_video2, drg_bapprovedate, approved, drg_blistingstatus, drg_bdeletedate, drg_breject_list, drg_page_visit, drg_last_page_visit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'drg_blid' => 'Drg Blid',
			'drg_whatwecando' => 'Drg Whatwecando',
			'drg_uid' => 'Drg Uid',
			...
			'drg_bapprovedate' => 'Drg Bapprovedate',
			'approved' => 'Approved',
			'drg_blistingstatus' => 'Drg Blistingstatus',
			'drg_bdeletedate' => 'Drg Bdeletedate',
			'drg_breject_list' => 'Drg Breject List',
			'drg_page_visit' => 'Drg Page Visit',
			'drg_last_page_visit' => 'Drg Last Page Visit',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('drg_whatwecando',$this->drg_whatwecando,true);
		...
		$criteria->compare('drg_blistingstatus',$this->drg_blistingstatus);
		$criteria->compare('drg_bdeletedate',$this->drg_bdeletedate,true);
		$criteria->compare('drg_breject_list',$this->drg_breject_list);
		$criteria->compare('drg_page_visit',$this->drg_page_visit);
		$criteria->compare('drg_last_page_visit',$this->drg_last_page_visit,true);
