...
$this->menu=array(
	...
	array('label'=>'Update Managelisting', 'url'=>array('update', 'id'=>$model->drg_lid)),
	array('label'=>'Delete Managelisting', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->drg_lid),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Managelisting', 'url'=>array('admin')),
);
?>

<h1>View Managelisting #<?php echo $model->drg_lid; ?></h1>
