...
<div class="image-robo-torso">
    <img width="120" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/robot/image-robo-torso.png"  alt=""/>
</div>

<div class="image-robo-hands">
    <img width="120" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/robot/image-robo-hands.png" alt=""/>
</div>
...
?>
    ...
    <form action="<?php echo Yii::app()->createUrl('/login'); ?>" method="post" name="login_form" id="login_form" onsubmit="return login_validation(this.form)" />
       <input onblur="if(this.value=='')this.value='Username'" onfocus="check_user_info(this.id);" type="text" name="drg_username" title="Please enter your username"  value="<?php if(isset($_COOKIE['username'])!=''){ echo $_COOKIE['username']; } else { echo "Username"; } ?>" id="drg_username" size="20"  />
        <div id="passwordbox">
            <input autocomplete="off" type="text" id="drg_pass" name="drg_pass" size="20" title="Please enter your password" onfocus="check_pass_info(this.id);" onblur="check_pass_out(this.id);" value="<?php if(isset($_COOKIE['password'])!=''){ echo $_COOKIE['password']; } else { echo "Password"; } ?>" />
        </div>
        <div id="login_check">
        </div>
            ...
            <ul>
                ...
                <li><span>Sign in to your account</span>
                    <span class="buttons-box">
                        <button class="login_sbmt" name="login_sbmt" type="submit" title='Log into your account'><img style="border-radius:5px; -moz-border-radius:5px; -o-border-radius:5px; -webkit-border-radius:5px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/user.png" width="25"  alt=""/></button>
                     </span>
                </li>
                <li><span>Lost your password</span>
                    <span class="buttons-box">
                        <a class="login_sbmt lpa" href="javaScript:void(0)" onclick="show_lost_pass_form()"  title='Reset your password'>
                            <img style="border-radius:5px; -moz-border-radius:5px; -o-border-radius:5px; -webkit-border-radius:5px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/lost.png" width="25" alt="" />
                        </a>
                     </span>
                 </li>
        ...
        <ul>
            <li>
                ...
                <span class="buttons-box">
                    ...
                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/user.png" width="25" alt="" />				 									  					</button>
                </span>
            </li>
            <li>
            <span>Return to index</span>
                <span class="buttons-box">
                    <a href="<?php echo Yii::app()->getBaseUrl(true); ?>" class="clearfix">
                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/user.png" width="25"  alt=""/>
                    </a>
                </span>
            </li>
        </ul>
...
<div id="reset_success" style="display:none">
    ...
    <div id="passreset-box">
        ...
        <p style='text-align:right; padding-top:44px;'><a href="<?php echo Yii::app()->baseUrl; ?>">Close &#062;&#062; </a></p>
