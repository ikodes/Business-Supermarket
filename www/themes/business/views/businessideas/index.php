<p class="breadcrumb"><a href="index.php">Home</a>&#062; business ideas </p>
<div>
        <?php 
...
<div class="sign-up-tabss"> <!-- start sign up tab -->
    ...
    <div id="tabs_content_container">
        ...
        <div id="taba" class="sign-up-tab_content" style="display: block;">
            <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">       
                <tr class="tableHeading">    
                    <td title="Sort in date order">
                        <select option value="Date" data-placeholder="Date" class="chzn-select" style="width:80px;">
                          <option value="" label="Select" title="Select option"></option>
                    ...
                    <td>
                        <select class="sl_lookfor chzn-select" name="drg_lookfor" data-placeholder="Looking for..." style="width:120px;" tabindex="2">
                          <option value="" label="Select" title="Select option"></option>
            ...
            <ul id="navlist">
                <li style="color:#C8C8C8;">&#060; previous</li>
                ...
                <tr class="tableHeading">
                    ...
                    <td title="Sample availability">
                        <select data-placeholder="Availability" class="chzn-select" style="width:110px;">
                          <option value="Select Country" label="Select" title="Select option"></option>
        ...
        <div id="tab6" class="sign-up-tab_content">
            <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
                <tr>
                    <td class="noteTemp">There are no listings currently open for investment</td>
                </tr>
            </table>
